...
class ClubsBloc extends Bloc<ClubSelectEvent, ClubsListState> {
  ...
  Stream<ClubsListState> _societyChangedToState(SocietyChanged event) async* {
    switch (event.society) {
      case 'Cult and Lit':
        yield ClubsListState.clubsLoaded(
            society: event.society, clubs: _cult, selected: event.selected);
        break;
      case 'Science and Tech':
        yield ClubsListState.clubsLoaded(
            society: event.society, clubs: _science, selected: event.selected);
        break;
      case 'Campus Life':
        yield ClubsListState.clubsLoaded(
      ...
      case 'Academics and Career':
        yield ClubsListState.clubsLoaded(
            society: event.society, clubs: _acads, selected: event.selected);
        break;
      case 'Sports and Games':
        yield ClubsListState.clubsLoaded(
            society: event.society, clubs: _sports, selected: event.selected);
        break;
      case 'Design and Arts':
        yield ClubsListState.clubsLoaded(
            society: event.society, clubs: _design, selected: event.selected);
        break;
      default:
        yield ClubsListState.initial();
    }
